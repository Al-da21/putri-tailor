...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Karena tabel Stock dihapus, ganti bestSellingProducts dengan query produk terjual dari TransactionDetail
        // $bestSellingProducts = TransactionDetail::selectRaw('products_id, SUM(quantity) as total_quantity')
        //     ->groupBy('products_id')
        //     ->orderByDesc('total_quantity')
        //     ->take(5)
        //     ->with('product') // pastikan relasi product ada di TransactionDetail
        //     ->get();
