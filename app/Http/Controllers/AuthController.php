...
class AuthController extends Controller
{
    ...
    public function doLogin(AuthLoginRequest $request)
    {
       ...
       if (Auth::user()->name === 'admin' || Auth::user()->name === 'karyawan') {
            return redirect('admin/dashboard')->with('success', 'Status: Sudah login');
        } else {
            return redirect('/')->with('info', 'Status: Sudah login');
        }
    }
